...
extends Module {
    ...
    private final Timer Field828 = new Timer();
    private final Timer Field829 = new Timer();
    private final Timer Field830 = new Timer();
    ...
    public HoleFiller() {
        super("HoleFiller", "Fills nearby holes with blocks.", Category.COMBAT, "");
    ...
    private boolean Method1083() {
        ...
        if (((Boolean)this.disable.getValue()).booleanValue() && this.Field828.booleanTime(((Integer)this.disabletime.getValue()).intValue())) {
            if (this.Field829.booleanTime(((Integer)this.offhanddelay.getValue()).intValue())) {
        ...
        if (!((Boolean)this.offhand.getValue()).booleanValue() && ((Boolean)this.silentswitch.getValue()).booleanValue()) {
            return !this.Field830.booleanTime(((Integer)this.placedelay.getValue()).intValue());
        }
