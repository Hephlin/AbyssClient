...
extends Module {
    ...
    public SelfTrap() {
        super("SelfTrap", "Traps the player by placing obsidian over your head.", Category.COMBAT, "");
            ...
            if (class285 == Class285.NoNeighbors) {
                ...
                for (BlockPos blockPos : blockPosArray = new BlockPos[]{this.Field787.north(), this.Field787.south(), this.Field787.east(), this.Field787.west(), this.Field787.up(), this.Field787.down().west()}) {
                    if (blockPos instanceof BlockPos) {
                        ...
                        if (class2852 == Class285.NoNeighbors || class2852 == Class285.NoEntityCollision || (class109 = Class110.Method1044(blockPos, 5.0f, false, false)) != Class109.Placed || !((Boolean) this.rotate.getValue()).booleanValue())
                            continue;
