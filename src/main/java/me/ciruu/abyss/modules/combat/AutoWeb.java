...
extends Module {
    ...
    public AutoWeb() {
        super("AutoWeb", "Automatically place cobwebs to nearby players.", Category.COMBAT, "");
    ...
    private EntityPlayer Method3092() {
        return (Boolean)this.actarget.getValue() != false && Manager.moduleManager.isModuleEnabled(AutoCrystal.class) && ((AutoCrystal)Manager.moduleManager.getModuleByClass(AutoCrystal.class)).player != null ? ((AutoCrystal)Manager.moduleManager.getModuleByClass(AutoCrystal.class)).player : Class30.Method1810(((Float)this.placerange.getValue()).floatValue());
    }
