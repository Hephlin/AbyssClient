...
extends Module {
    ...
    public Tracers() {
        super("Tracers", "Draws tracer lines to players.", Category.RENDER, "");
    ...
    private void Method4054(Class66 class66) {
        ...
        for (Entity entity : Globals.mc.world.loadedEntityList) {
            if (entity instanceof Entity) {
                Vec3d vec3d;
                if (!this.Method4056(entity) || (vec3d = Class29.Method3453(entity, class66.Method1789()).subtract(Globals.mc.getRenderManager().renderPosX, Globals.mc.getRenderManager().renderPosY, Globals.mc.getRenderManager().renderPosZ)) == null) {
                    continue;
                }
