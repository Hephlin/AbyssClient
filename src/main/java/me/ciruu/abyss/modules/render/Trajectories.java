...
extends Module {
    ...
    public Trajectories() {
        super("Trajectories", "Shows the trajectory throwable items.", Category.RENDER, "");
        ...
        if (Class318.Method1194(class318)) {
            ...
            if (vec3d2.typeOfHit == RayTraceResult.Type.BLOCK) {
                ...
                if (iBlockState.getMaterial() != Material.AIR && Globals.mc.world.getWorldBorder().contains(blockPos)) {
                    Vec3d vec3d3 = Class29.Method3453((Entity)Globals.mc.player, Globals.mc.getRenderPartialTicks());
