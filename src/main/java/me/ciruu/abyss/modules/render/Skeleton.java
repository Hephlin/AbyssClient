...
extends Module {
    ...
    public Skeleton() {
        super("Skeleton", "Renders a skeleton on players.", Category.RENDER, "");
    ...
    private void Method2430(Class66 class66) {
        ...
        for (EntityPlayer entityPlayer : Globals.mc.world.playerEntities) {
            if (entityPlayer instanceof EntityPlayer) {
                if (entityPlayer.isInvisible() && !((Boolean) this.invisibles.getValue()).booleanValue() || entityPlayer == null || entityPlayer == Globals.mc.getRenderViewEntity() || !entityPlayer.isEntityAlive() || entityPlayer.isPlayerSleeping() || this.Field1999.get(entityPlayer) == null || !(Globals.mc.player.getDistanceSq((Entity) entityPlayer) < 2500.0))
                    continue;
