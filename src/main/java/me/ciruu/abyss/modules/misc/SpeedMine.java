...
extends Module {
    ...
    private final Timer Field2838 = new Timer();
    private final Timer Field2839 = new Timer();
    ...
    public SpeedMine() {
        super("SpeedMine", "Mines blocks faster.", Category.MISC, "");
    ...
    private void Method3432(Class66 class66) {
        if (((Boolean)this.render.getValue()).booleanValue() && this.Field2833 != null && Globals.mc.world.getBlockState(this.Field2833).getBlock() != Blocks.AIR && this.mode.getValue() == Class634.Packet) {
            if (this.rendermode.getValue() == Class595.Progressive) {
                ...
                Color color = this.Field2838.booleanTime((int)(2000.0f * Manager.Field1645.Method2895())) ? (Color)this.endcolor.getValue() : (Color)this.startcolor.getValue();
    ...
    private void Method3428(EventPlayerUpdate eventPlayerUpdate) {
        ...
        if (((Boolean)this.silentswitch.getValue()).booleanValue() && this.Field2839.booleanTime((int)((2000.0f + (float)((Integer)this.delay.getValue()).intValue()) * Manager.Field1645.Method2895())) && n != -1 && this.Field2833 != null && Globals.mc.world.getBlockState(this.Field2833).getBlock() != Blocks.AIR && this.Field2842) {
