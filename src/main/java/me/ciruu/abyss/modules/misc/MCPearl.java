...
extends Module {
    ...
    private final Timer Field1333 = new Timer();
    @EventHandler
    ...
    public MCPearl() {
        super("MCPearl", "Throw an ender pearl by clicking the wheel button in mouse.", Category.MISC, "");
        this.addSetting(this.delay);
    }

    private void Method1750(EventPlayerUpdate eventPlayerUpdate) {
        if (this.Field1332 && this.Field1333.booleanTime(((Float)this.delay.getValue()).longValue())) {
