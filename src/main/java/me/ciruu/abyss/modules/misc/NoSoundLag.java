...
extends Module {
    ...
    public NoSoundLag() {
        super("NoSoundLag", "Prevents lag from sound packets.", Category.MISC, "");
    }
    ...
    public static void Method3061(SPacketSoundEffect sPacketSoundEffect, float f) {
        ...
        for (Entity entity : Globals.mc.world.loadedEntityList) {
            if (entity instanceof Entity) {
                if (!(entity instanceof EntityEnderCrystal) || !(entity.getDistanceSq(blockPos) <= Class29.getDouble6(f)))
                    continue;
