...
extends Module {
    ...
    private void Method2383(Class35 class35) {
        ...
        if (((Boolean)this.acTarget.getValue()).booleanValue() && Manager.moduleManager.isModuleEnabled(AutoCrystal.class) && ((AutoCrystal)Manager.moduleManager.getModuleByClass(AutoCrystal.class)).player != null) {
            entityPlayer = ((AutoCrystal)Manager.moduleManager.getModuleByClass(AutoCrystal.class)).player;
        }
