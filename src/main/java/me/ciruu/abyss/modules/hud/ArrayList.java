...
extends Module {
    ...
    private boolean Method2635(Module module) {
        return !module.Method492() && (module.getStatus() || (Boolean)this.animation.getValue() != false && module.Method588() != 0.0f && module.Method588() != -1.0f);
    }
