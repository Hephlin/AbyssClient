...
extends Module {
    ...
    @EventHandler
    private final Listener Field780 = new Listener<Class35>(this::getEnable, new Predicate[0]);

    public WebChatList() {
        super("WebChatList", "", Category.HUD, "");
    ...
    private void Method1028() {
        this.Field774.clear();
        this.Field774.putAll(((WebChat)Manager.moduleManager.getModuleByClass(WebChat.class)).getUpdate());
