...
extends Module {
    ...
    private final Timer Field3079 = new Timer();
    ...
    public CrystalCounter() {
        super("CrystalCounter", "", Category.HUD, "");
    ...
    private void Method3724(EventNetworkPrePacketEvent eventNetworkPrePacketEvent) {
        ...
        if (packet instanceof SPacketDestroyEntities) {
            ...
            for (Object n : destroyPacket.getEntityIDs()) {
    ...
    private void Method3730() {
        while (this.isEnabled()) {
            if (!this.Field3079.booleanTime(1000L)) continue;
            this.Method3732();
            this.Field3079.reset();
        }
    }
