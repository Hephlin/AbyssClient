...
public class Class471 {
    ...
    public void Method2195(Color color, float f, boolean bl, float f2, float f3, Class35 class35) {
        if (bl) {
            int n = 1;
            for (Object class390_ : this.Field1801) {
                if (class390_ instanceof Class390) {
                    Class390 class390 = (Class390) class390_;
            ...
            for (Object class390_ : this.Field1801) {
                if (class390_ instanceof Class390) {
                    for (Object class390 : this.Field1801) {
                        if (class390 instanceof Class390) {
                            Class390 class3902 = (Class390) class390;
                            if (!(class3902.Method1646(class3902) <= f)) continue;
                            Class50.Method817(((Class390) class390).Method1633(), ((Class390) class390).Method1637(), class3902.Method1633(), class3902.Method1637(), f3, ((Class390) class390).Method1643().getRGB(), class3902.Method1643().getRGB());
                        }
                    }
                }
            }
            ...
            for (Object class390_ : this.Field1801) {
                if (class390_ instanceof Class390) {
                    ...
                    for (Object class3903_ : this.Field1801) {
                        if (class3903_ instanceof Class390) {
                            Class390 class3903 = (Class390) class3903_;
    ...
    private static void Method2197(Object o) {
        Method2197(o);
    }

    public void Method2198(int n, float f) {
        ScaledResolution scaledResolution = new ScaledResolution(Globals.mc);
        this.Field1801.forEach(arg_0 -> Class471.Method2199(n, f, (Class390) arg_0));
        this.Field1801.forEach(arg_0 -> Class471.Method2200(scaledResolution, (Class390) arg_0));
    }
