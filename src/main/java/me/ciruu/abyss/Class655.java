...
implements Function1 {
    ...
    public final void invoke(@NotNull Class35 class35) {
        ...
        if (autoCrystal.isEnabled()) {
            ...
            if (autoCrystal.player != null) {
                Class656.Method3860(this.Field3180, "AutoCrystal:" + ChatFormatting.AQUA + autoCrystal.player.getName());
                Class36.Method63(Class656.Method3861(this.Field3180), ((Number)Class656.Method3862(this.Field3180).getValue()).intValue(), ((Number)Class656.Method3863(this.Field3180).getValue()).intValue(), -1);
            }
        } else {
        ...
        if (((Boolean)predict.predict.getValue()).booleanValue() && Manager.moduleManager.isModuleEnabled(AutoCrystal.class) && Manager.moduleManager.isModuleEnabled(Predict.class)) {
            ...
            n = 0;
            for (Object object3_ : arrayList) {
                if (object3_ instanceof ArrayList) {
                    object3_ = (Object) object3;
            ...
            Class656.Method3860(this.Field3180, "Predict media:" + ChatFormatting.DARK_AQUA + Class29.getFloatCollection(arrayList3) + ChatFormatting.RESET + ", Moda:" + ChatFormatting.DARK_AQUA + Class29.getFloatCollectionAmount(arrayList3));
            ...
            Class656.Method3860(this.Field3180, "LastEntityId:" + ChatFormatting.DARK_AQUA + Predict.Field19.int1);
