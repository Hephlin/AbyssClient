...
public class Class133 {
    ...
    public void addSetting1(Class134[] class134Array, char c, float f, float f2) throws ArrayIndexOutOfBoundsException {
        try {
            this.addSetting(f, f2, class134Array[c].Field314, class134Array[c].Field315, class134Array[c].Field316, class134Array[c].Field317, class134Array[c].Field314, class134Array[c].Field315);
        }
        catch (Exception exception) {
            exception.printStackTrace();
        }
    ...
    protected void addSetting(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
    ...
    public int addSetting5(String string) {
        return this.addSetting6();
    }

    public int addSetting6() {
        return (this.Field311 - 8) / 2;
    }

    public int addSetting7(String string) {
        int n = 0;
