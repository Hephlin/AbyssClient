...
public class Class155 {
    ...
    public static int Method3003(Item item, boolean bl) {
        ...
        atomicInteger.set(-1);
        for (Object entry_ : Class155.Method3004().entrySet()) {
            if (entry_ instanceof Map.Entry) {
    ...
    public static List Method1807(boolean bl) {
        ...
        for (Object slot_ : Class155.Method3004().entrySet()) {
            if (slot_ instanceof Slot) {
                Map.Entry slot = (Map.Entry) slot_;
