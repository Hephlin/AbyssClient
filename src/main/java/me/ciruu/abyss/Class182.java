...
extends Module {
    ...
    public Class182() {
        super("CustomChat", "", Category.CLIENT, "");
        this.addSetting(this.Field406);
        this.addSetting(this.Field407);
        this.addSetting(this.Field408);
        this.addSetting(this.Field409);
        this.addSetting(this.Field410);
        this.addSetting(this.Field411);
        this.addSetting(this.Field412);
        this.addSetting(this.Field413);
        this.addSetting(this.Field414);
    }
    ...
    private void Method499(EventNetworkPrePacketEvent eventNetworkPrePacketEvent) {
        Object rawPacket = eventNetworkPrePacketEvent.getPacket(); // Probably returns Class53
        if (rawPacket instanceof SPacketChat) {
            SPacketChat sPacketChat = (SPacketChat) rawPacket;
            if (sPacketChat.getType() != ChatType.GAME_INFO) {
                try {
