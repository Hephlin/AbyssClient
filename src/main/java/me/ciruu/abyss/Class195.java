...
public class Class195 {
    ...
    public void Method3535(BlockPos blockPos) {
        float[] fArray = Class29.getFloatVector(Globals.mc.player.getPositionEyes(Globals.mc.getRenderPartialTicks()), new Vec3d((double)((float)blockPos.getX() + 0.5f), (double)((float)blockPos.getY() + 0.5f), (double)((float)blockPos.getZ() + 0.5f)));
        this.Method523(fArray[0], fArray[1]);
    }

    public void Method1265(Vec3d vec3d) {
        float[] fArray = Class29.getFloatVector(Globals.mc.player.getPositionEyes(Globals.mc.getRenderPartialTicks()), new Vec3d(vec3d.x, vec3d.y, vec3d.z));
        this.Method523(fArray[0], fArray[1]);
    }
    ...
    public void Method2897(Entity entity) {
        float[] fArray = Class29.getFloatVector(Globals.mc.player.getPositionEyes(Globals.mc.getRenderPartialTicks()), entity.getPositionEyes(Globals.mc.getRenderPartialTicks()));
        this.Method523(fArray[0], fArray[1]);
    }
