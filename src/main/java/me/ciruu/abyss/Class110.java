...
public class Class110 {
    ...
    public static void Method1088(BlockPos blockPos, EnumHand enumHand) {
        ...
        for (EnumFacing enumFacing : EnumFacing.values()) {
            if (enumFacing instanceof EnumFacing) {
                ...
                if (!Class110.Method2174(blockPos2) || vec3d.squareDistanceTo(vec3d2 = new Vec3d((Vec3i) blockPos2).add(0.5, 0.5, 0.5).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5))) > 18.0625)
                    continue;
                ...
                if (blockPos2 instanceof BlockPos) {
                    ...
                    for (EnumFacing enumFacing : EnumFacing.values()) {
                        if (enumFacing instanceof EnumFacing) {
                            ...
                            if (!Class110.Field1795.world.getBlockState(blockPos3).getBlock().canCollideCheck(Class110.Field1795.world.getBlockState(blockPos3), false))
                                continue;
                            return Class285.Ok;
                        }
                    }
    ...
    public static Class109 Method2183(BlockPos blockPos, float f, boolean bl, boolean bl2, boolean bl3, EnumHand enumHand) {
        ...
        Object x = (Object)class285;
        Class285 vec3d2 = (Class285) x;

        if (!bl5 && (vec3d2 = Class110.Method1043(blockPos)) != Class285.Ok && !bl4) {
        ...
        for (EnumFacing enumFacing : EnumFacing.values()) {
            if (enumFacing instanceof EnumFacing) {
                ...
                if (!Class110.Field1795.world.getBlockState(blockPos2).getBlock().canCollideCheck(Class110.Field1795.world.getBlockState(blockPos2), false) || !(class285.distanceTo(vec3d = new Vec3d((Vec3i) blockPos2).add(0.5, 0.5, 0.5).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5))) <= (double) f))
                    continue;
                ...
                if ((enumActionResult = Class110.Field1795.playerController.processRightClickBlock(Class110.Field1795.player, Class110.Field1795.world, blockPos2, enumFacing2, vec3d, enumHand)) == EnumActionResult.FAIL)
                    continue;
                if (bl3) {
