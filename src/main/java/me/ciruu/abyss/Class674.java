...
extends Module {
    ...
    private final Timer Field3470 = new Timer();
    @EventHandler
    private Listener Field3471 = new Listener<Class26>(this::Method4207, new Predicate[0]);

    public Class674() {
        super("7kIlegalPlacer", "", Category.EXPLOIT, "");
        this.addSetting(this.Field3463);
        this.addSetting(this.Field3464);
        this.addSetting(this.Field3465);
    }
    ...
    private void Method4207(Class26 class26) {
        ...
        if (this.Field3468 != -1) {
            ...
            this.Field3467 = true;
            if (this.Field3470.booleanTime(((Integer)this.Field3463.getValue()).intValue())) {
                Globals.mc.displayGuiScreen(null);
