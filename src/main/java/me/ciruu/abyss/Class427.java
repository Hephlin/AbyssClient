...
extends Module {
    ...
    public Class427() {
        ...
        this.addSetting(this.Field3189);
        this.addSetting(this.Field3190);
        this.addSetting(this.Field3191);
        this.addSetting(this.Field3192);
        this.addSetting(this.Field3193);
        this.addSetting(this.Field3194);
        this.addSetting(this.Field3195);
    }
    ...
    private void Method3873(EventNetworkPostPacketEvent eventNetworkPostPacketEvent) {
        if (eventNetworkPostPacketEvent.mb_packet instanceof CPacketPlayer) {
            if (this.Field3201.contains((CPacketPlayer)eventNetworkPostPacketEvent.mb_packet)) {
                this.Field3201.remove((CPacketPlayer)eventNetworkPostPacketEvent.mb_packet);
            } else {
    ...
    private void Method3869(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        if (eventPlayerUpdateWalking.getClass53() == Class53.PRE && this.Field3200) {
    ...
    private void Method3868(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        ...
        if (Globals.mc.player.movementInput.moveStrafe != 0.0f || Globals.mc.player.movementInput.moveForward != 0.0f) {
            double[] dArray = Class29.getDouble10(bl ? (double)((Float)this.Field3194.getValue()).floatValue() : 0.26);
