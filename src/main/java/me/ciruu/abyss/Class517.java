...
extends Class52 {
    ...
    public void Method2459(EventPlayerMove eventPlayerMove) {
        if (eventPlayerMove.era != Class53.PRE || eventPlayerMove.isCancelled() || Globals.mc.player == null) {
            return;
        }
        if (Globals.mc.player.fallDistance > 4.0f) {
            return;
        }
        if (Class29.getDouble7(Globals.mc.player.posY - (double)((int)Globals.mc.player.posY), 3) == Class29.getDouble7(0.138, 3)) {
            Globals.mc.player.motionY -= 1.0;
            eventPlayerMove.getDoubVal5(eventPlayerMove.getDoubVal2() - 0.0931);
        ...
        if (this.Field2019 == 1 && (Globals.mc.player.moveForward != 0.0f || Globals.mc.player.moveStrafing != 0.0f)) {
            ...
            eventPlayerMove.getDoubVal5(bl ? 0.42 : 0.4);
            eventPlayerMove.cancel();
        ...
        eventPlayerMove.getDoubVal4((double)f * this.Field2021 * d + (double)f2 * this.Field2021 * d2);
        eventPlayerMove.getDoubVal6((double)f * this.Field2021 * d2 - (double)f2 * this.Field2021 * d);
        ++this.Field2019;
    }
