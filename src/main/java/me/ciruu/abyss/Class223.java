...
implements Class70 {
    ...
    public void Method1669() {
        if (!this.Field1319) {
            ...
            switch (Class263.Field706[this.Field1318.hashCode()]) {
                case 1: {
                    string = "HEX";
                    break;
                }
            ...
            switch (Class263.Field707[this.Field1318.hashCode()]) {
                case 1: {
    ...
    private final void Method1718(int option, String input) {
        Color newColor = null;
        float[] currentHSB = Color.RGBtoHSB(
                this.Method1651().getRed(),
                this.Method1651().getGreen(),
                this.Method1651().getBlue(),
                null
        );
        ...
        switch (option) {
            case 0: {
                ...
                Color parsedColor = Class140.Method649(trimmed);
                newColor = parsedColor != null ? parsedColor : this.Method1651();
                break;
            }
            case 1: {
                int red = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : this.Method1651().getRed();
                red = RangesKt.coerceIn(red, 0, 255);
                newColor = new Color(red, this.Method1651().getGreen(), this.Method1651().getBlue(), this.Method1651().getAlpha());
                break;
            }
            case 2: {
                int green = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : this.Method1651().getGreen();
                green = RangesKt.coerceIn(green, 0, 255);
                newColor = new Color(this.Method1651().getRed(), green, this.Method1651().getBlue(), this.Method1651().getAlpha());
                break;
            }
            case 3: {
                int blue = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : this.Method1651().getBlue();
                blue = RangesKt.coerceIn(blue, 0, 255);
                newColor = new Color(this.Method1651().getRed(), this.Method1651().getGreen(), blue, this.Method1651().getAlpha());
                break;
            }
            case 4: {
                int hue = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : (int)(currentHSB[0] * 255);
                this.Field1302 = RangesKt.coerceIn(hue, 0, 255) / 255.0f;
                this.Method1714();
                return;
            }
            case 5: {
                int saturation = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : (int)(currentHSB[1] * 255);
                this.Field1300 = RangesKt.coerceIn(saturation, 0, 255) / 255.0f;
                this.Method1714();
                return;
            }
            case 6: {
                int brightness = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : (int)(currentHSB[2] * 255);
                this.Field1301 = 1.0f - RangesKt.coerceIn(brightness, 0, 255) / 255.0f;
                this.Method1714();
                return;
            }
            case 7: {
                int alpha = StringsKt.toIntOrNull(input) != null ? StringsKt.toIntOrNull(input) : this.Method1651().getAlpha();
                alpha = RangesKt.coerceIn(alpha, 0, 255);
                newColor = new Color(this.Method1651().getRed(), this.Method1651().getGreen(), this.Method1651().getBlue(), alpha);
                break;
            }
            default:
                return;
        ...
        if (newColor != null) {
            float[] newHSB = Color.RGBtoHSB(newColor.getRed(), newColor.getGreen(), newColor.getBlue(), null);
            this.Field1303 = newColor.getAlpha() / 255.0f;
            this.Field1302 = newHSB[0];
            this.Field1300 = newHSB[1];
            this.Field1301 = 1.0f - newHSB[2];
            this.Method1714();
        }
    }
