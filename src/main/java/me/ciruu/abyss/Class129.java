...
public class Class129 {
    ...
    private final Timer Field1626 = new Timer();
    ...
    public void Method346(float f, float f2, float f3, float f4) {
        ...
        if (this.Field1626.booleanTime((long)f3) && this.Field1632) {
            this.Field1631 += f4;
    ...
    public boolean Method345(float f) {
        return new Timer().booleanTime((long) f) && this.Field1630;
    }
