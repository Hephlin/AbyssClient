...
implements Class70 {
    ...
    @Nullable
    private final Setting Field2115 = null;
    ...
    public int Method2553() {
        ...
        if (!this.Field2111) {
            ...
            for (Object t : iterable2) {
                if (t instanceof Iterable) {
                    ...
                    if (!Intrinsics.areEqual(setting != null ? setting.mainSettings : null, this.Field2116.getSetting()))
                        continue;
                    object.add(t);
                }
            }
            ...
            for (Object t : iterable2) {
                if (t instanceof Iterable) {
                    class70 = (Class70) t;
                    bl2 = false;
                    Object object2 = (Class70) class70.Method2232();
                    if (!(object2 != null && (object2 = ((Setting) object2).Method2561()) != null ? ((BooleanSupplier) object2).getAsBoolean() : true))
                        continue;
                    object.add(t);
                }
            }
        ...
        int n9 = n5 + n4;
        if (this.Field2111) {
            iterable = this.Field2122.getSettings();
            n3 = n9;
            bl = false;
            n2 = !((List<?>) iterable).isEmpty() ? 1 : 0;
            n9 = n3;
            if (n2 != 0) {
                n = 16;
                return n9 + n;
    ...
    public int Method2568() {
        int n = Class36.Method259(this.Field2122.getContext() + " >") + 5;
        Iterable iterable = this.Field2110;
        boolean bl = false;
        Iterable iterable2 = iterable;
        int size = (iterable.iterator().hashCode() >= 10) ? iterable.iterator().hashCode() : 10;
        Collection collection = new ArrayList(size);
        boolean bl2 = false;
        for (Object t : iterable2) {
            if (t instanceof Iterable) {
        ...
        Integer n3 = Collections.max((List<Integer>) collection);
        int n4 = n3 != null ? n3 : 0;
        bl = false;
    ...
    private final void Method2579() {
        ...
        if (!((List<?>) object2).isEmpty()) {
            ...
            for (Object object49490 : Manager.Field1638.Method2580(this.Field2122)) {
                if (object49490 instanceof Manager) {
                    Class70 class70;
                    Object object3;
                    Object object4 = ((Setting) object2).getValue();
                    if (object4 instanceof Class25) {
                        this.Field2116.Method2583().add(((Class25) object4).getString());
                    }
    ...
    private final void Method2586() {
        int n = 16;
        for (Object class70_1 : this.Field2110) {
            if (class70_1 instanceof ArrayList) {
                Class70 class70 = (Class70) class70_1;
                ...
                if (object != null && (object = ((Setting) object).Method2561()) != null && !((BooleanSupplier) object).getAsBoolean())
                    continue;
                Setting setting = class70.Method2232();
                if (!StringsKt.equals(setting != null ? setting.mainSettings : null, this.Field2116.getSetting(), false))
                    continue;
                class70.Method2236(n);
                n += class70.Method2238();
            }
    ...
    public void Method2589() {
        ...
        Class36.Method63(this.Field2122.getContext(), this.Method2594() + 2, this.Method2595() + 2 + 2, Class74.Field172.Method171().getRGB());
        ...
        if (this.Field2111) {
            ...
            if (!((ArrayList<?>) object2).isEmpty()) {
                for (Object object394 : this.Field2110) {
                    if (object394 instanceof ArrayList) {
                        object2 = (Object) object394;
                        if (object2 instanceof Class546 || object2 instanceof Class69) {
                            Method2244();
                            continue;
                        }
                        Object object3 = Method2232();
                        if (object3 != null && (object3 = ((Setting) object3).Method2561()) != null && !((BooleanSupplier) object3).getAsBoolean())
                            continue;
                        Setting setting = Method2232();
                        if (!StringsKt.equals(setting != null ? setting.mainSettings : null, this.Field2116.getSetting(), false))
                            continue;
                        Method2244();
                    }
    ...
    public void Method2597(int n, int n2) {
        ...
        boolean bl = false;
        if (!((ArrayList<?>) object2).isEmpty()) {
            for (Object object303 : this.Field2110) {
                if (object303 instanceof ArrayList) {
                    object303 = (Object) object2;
                    if (object2 instanceof Class546 || object2 instanceof Class69) {
                        ((Class70) object2).Method2245(n, n2);
                        continue;
                    }
                    Object object3 = Method2232();
                    if (object3 != null && (object3 = ((Setting) object3).Method2561()) != null && !((BooleanSupplier) object3).getAsBoolean())
    ...
    public void Method2600(int n, int n2, int n3) {
        ...
        if (this.Method2599(n, n2) && n3 == 2) {
            ...
            Class547.printChatMessage(this.Field2122.getContext() + " visibility:" + (!this.Field2122.Method492() ? chatFormatting + " ON" : chatFormatting2 + " OFF"));
            return;
        }
        for (Class70 class70 = (Class70)null; class70 == this.Field2110;) {
            if (class70 instanceof Class70) {
                if (class70 instanceof Class546 || class70 instanceof Class69) {
                ...
                if (object != null && (object = ((Setting) object).Method2561()) != null && !((BooleanSupplier) object).getAsBoolean())
                    continue;
                Setting setting = class70.Method2232();
                if (Intrinsics.areEqual(setting != null ? setting.mainSettings : null, this.Field2116.getSetting()) ^ true)
                    continue;
                class70.Method2246(n, n2, n3);
                this.Method2566().Method2601();
            }
        ...
        if (((Boolean)((ClickGUI)Manager.moduleManager.getModuleByClass(ClickGUI.class)).gradientenabled.getValue()).booleanValue() && ((Boolean)((ClickGUI)Manager.moduleManager.getModuleByClass(ClickGUI.class)).renabled.getValue()).booleanValue()) {
            if ((Class218)((Object)((ClickGUI)Manager.moduleManager.getModuleByClass(ClickGUI.class)).gradientmode.getValue()) == Class218.Button) {
                if (!((Boolean)((ClickGUI)Manager.moduleManager.getModuleByClass(ClickGUI.class)).ignoredisabled.getValue()).booleanValue()) {
                    Class50.Method863(this.Method2594(), this.Method2595(), this.Method157(), 16, this.Field2122.getStatus() ? Class74.Field172.Method413().getRGB() : Class74.Field172.Method165().getRGB(), this.Field2122.getStatus() ? Class74.Field172.Method702().getRGB() : Class74.Field172.Method165().getRGB());
                } else {
                ...
                if (!((Boolean)((ClickGUI)Manager.moduleManager.getModuleByClass(ClickGUI.class)).ignoredisabled.getValue()).booleanValue()) {
                    Class50.Method863(this.Method2594(), this.Method2595(), this.Method157(), 16, this.Field2122.getStatus() ? this.Field2120.getRGB() : Class74.Field172.Method165().getRGB(), this.Field2122.getStatus() ? this.Field2121.getRGB() : Class74.Field172.Method165().getRGB());
                } else {
                    Class50.Method863(this.Method2594(), this.Method2595(), this.Method157(), 16, this.Field2120.getRGB(), this.Field2121.getRGB());
                }
            }
        } else {
            Gui.drawRect((int)this.Method2594(), (int)this.Method2595(), (int)(this.Method2594() + this.Method157()), (int)(this.Method2595() + 16), (int)(this.Field2122.getStatus() ? Class74.Field172.Method413().getRGB() : Class74.Field172.Method165().getRGB()));
        }
    }
    ...
    private final void Method2593(boolean bl) {
        Manager.GUI.getDesc().Method2607(this.Field2122.Method586());
        Manager.GUI.getDesc().Method2608(Class36.Method260());
        Manager.GUI.getDesc().Method2609(Class36.Method259(this.Field2122.Method586()));
        Manager.GUI.getDesc().Method2610(bl && !this.Field2122.Method586().equals(""));
    }
