...
extends Class52 {
    ...
    public void Method2899(EntityPlayerAttackEntityFrom entityPlayerAttackEntityFrom) {
        if (this.Method2900(entityPlayerAttackEntityFrom.getDMGSource())) {
            return;
        }
    ...
    public void Method2905(EventPlayerMove eventPlayerMove) {
        if (eventPlayerMove.era != Class53.PRE || eventPlayerMove.isCancelled() || Globals.mc.player == null || eventPlayerMove.movet() != MoverType.SELF) {
            return;
        }
