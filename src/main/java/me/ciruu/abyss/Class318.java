...
public final class Class318 {
    ...
    public void Method1185() {
        ...
        this.Field922 = Class29.getFloatVector(this.Field922, f);
    ...
    private void Method1187(Vec3d vec3d, RayTraceResult rayTraceResult) {
        ...
        for (Object entity2_ : list) {
            if (entity2_ instanceof Entity) {
                Entity entity2 = (Entity) entity2_;
                double d2;
    ...
    private void Method1184(Vec3d vec3d, float f) {
        this.Field922 = Class29.getDivisionFloatVector(vec3d, (float)vec3d.length());
        this.Field922 = Class29.getFloatVector(this.Field922, f);
    }
    ...
    public static boolean Method1194(Class318 class318) {
        return class318.Field926;
    }

    public static RayTraceResult Method1195(Class318 class318) {
