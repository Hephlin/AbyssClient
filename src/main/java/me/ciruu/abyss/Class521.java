...
extends Class52 {
    ...
    public void Method2450(EventPlayerMove eventPlayerMove) {
        if (eventPlayerMove.era != Class53.PRE || eventPlayerMove.isCancelled()) {
            return;
        }
        ...
        if (this.Method2452(Globals.mc.player.posY - (double)((int)Globals.mc.player.posY)) == this.Method2452(0.138)) {
            ...
            eventPlayerMove.getDoubVal5(eventPlayerMove.getDoubVal2() - 0.09316090325960147);
        ...
        if (this.Field2015 == 1 && (Globals.mc.player.moveForward != 0.0f || Globals.mc.player.moveStrafing != 0.0f)) {
            ...
            eventPlayerMove.getDoubVal5(0.3994f);
        ...
        eventPlayerMove.getDoubVal4((double)f * this.Field2014 * d + (double)f2 * this.Field2014 * d2);
        eventPlayerMove.getDoubVal6((double)f * this.Field2014 * d2 - (double)f2 * this.Field2014 * d);
