...
public class Class108 {
    ...
    public static Class273 Method1012(BlockPos blockPos, boolean bl, boolean bl2) {
        ...
        if (hashMap.containsKey((Object)Class107.DOWN) && hashMap.remove((Object)Class107.DOWN, (Object)Class272.BREAKABLE) && !bl2) {
            class273.addSetting05(Class272.BREAKABLE);
            return class273;
        }
        int n = hashMap.size();
        hashMap.entrySet().removeIf(Class108::Method3856);
        if (hashMap.size() != n) {
            class273.addSetting05(Class272.RESISTANT);
        }
        if ((n = hashMap.size()) == 0) {
            class273.addSetting04(Class274.SINGLE);
            class273.addSetting06(new AxisAlignedBB(blockPos));
            return class273;
        }
        if (n == 1 && !bl) {
    ...
    private static boolean Method3856(Object o) {
        return true;
    }
    ...
    private static Class273 Method3857(Class273 class273, BlockPos blockPos, Class107 class107) {
        ...
        if (hashMap.containsKey((Object)Class107.DOWN)) {
            class273.addSetting04(Class274.CUSTOM);
            hashMap.remove((Object)Class107.DOWN);
        }
        if (hashMap.size() > 1) {
            class273.addSetting04(Class274.NONE);
            return class273;
        }
        ...
        class273.addSetting06(new AxisAlignedBB(d, (double)blockPos.getY(), d3, d2, (double)(blockPos.getY() + 1), d4));
        if (class273.Method1013() != Class274.CUSTOM) {
            class273.addSetting04(Class274.DOUBLE);
        }
        return class273;
    }

    private static boolean Method3858(Object o) {
        return true;
    }
