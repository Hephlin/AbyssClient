...
implements Function1 {
    ...
    public final void invoke(@NotNull Class35 class35) {
        ...
        if (class152.Field1125 || ((Boolean)class152.Field995.getValue()).booleanValue() || ((Boolean)class152.Field1012.getValue()).booleanValue()) {
            ...
            Class538.Method2442(this.Field2013, "Predict media:" + ChatFormatting.DARK_AQUA + Class29.getFloatCollection(arrayList3) + ChatFormatting.RESET + ", Moda:" + ChatFormatting.DARK_AQUA + Class29.getFloatCollectionAmount(arrayList3));
