...
extends Module {
    ...
    public Class431() {
        super("LongJumpOld", "", Category.MOVEMENT, "");
        this.addSetting(this.Field1421);
        this.addSetting(this.Field1422);
        this.addSetting(this.Field1423);
    }
    ...
    private void Method1824(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        switch ((Class433)((Object)this.Field1423.getValue())) {
            case Yes: {
                ...
                if (Class30.Method1834() || Class30.Method1835() || eventPlayerUpdateWalking.getClass53() != Class53.PRE) break;
