...
public class Class84 {
    ...
    public static float[] Method3236(Entity entity) {
        return Class29.getFloatVector(Globals.mc.player.getPositionEyes(Globals.mc.getRenderPartialTicks()), entity.getPositionEyes(Globals.mc.getRenderPartialTicks()));
    }
