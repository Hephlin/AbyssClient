...
public class Class386 {
    public static InventoryPlayer addSetting83() {
    ...
    public static Container addSetting82() {
    ...
    public static List Method4261() {
        ...
        int n = 0;
        for (ItemStack itemStack : Class386.addSetting83().mainInventory) {
    ...
    public static List addSetting72() {
        return Class386.Method4264(9, 36);
    }

    public static List addSetting79() {
        return Class386.Method4263(0, Class386.Method4260());
    }

    public static Class385 addSetting71() {
        return Class386.Method4266(Class386.addSetting83().getItemStack(), -999);
    }

    public static Class385 Method4267() {
        return (Class385)Class386.Method4261().get(Class386.addSetting83().currentItem);
    }
    ...
    public static int addSetting86(Class385 class385) {
    ...
    public static void Method4269(int n, int n2, ClickType clickType, ItemStack itemStack) {
        Class354.Field2646.player.connection.sendPacket((Packet)new CPacketClickWindow(0, n, n2, clickType, itemStack, Class386.addSetting82().getNextTransactionID(Class386.addSetting83())));
    }
    ...
    public static ItemStack Method4270(Class385 class385, int n, ClickType clickType) {
        ...
        ItemStack itemStack = Class386.addSetting82().slotClick(class385.getSlotNumber(), n, clickType, (EntityPlayer)Class354.Field2646.player);
