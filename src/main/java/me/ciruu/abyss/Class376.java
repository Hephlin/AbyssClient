...
extends Module {
    ...
    public Class376() {
        super("SelfWeb", "Puts a cobweb in your feet", Category.COMBAT, "");
        this.addSetting(this.Field1230);
        this.addSetting(this.Field1232);
        this.addSetting(this.Field1231);
    ...
    private static void Method1578(EventNetworkPostPacketEvent eventNetworkPostPacketEvent) {
        Packet packet = eventNetworkPostPacketEvent.mb_packet;
