...
extends Class52 {
    ...
    public void Method99(EventPlayerUpdateWalking eventPlayerUpdateWalking) {
        if (eventPlayerUpdateWalking.getClass53() != Class53.PRE || Globals.mc.player == null) {
            return;
        }
    ...
    public void Method101(EventPlayerMove eventPlayerMove) {
        if (eventPlayerMove.movet() != MoverType.SELF || Globals.mc.player.fallDistance > 4.0f || Globals.mc.player.getRidingEntity() != null) {
            return;
        }
        switch (this.Field132) {
            ...
            case 1: {
                ...
                eventPlayerMove.getDoubVal5(0.40123128);
    ...
    public void Method111(SPacketEntityVelocity sPacketEntityVelocity) {
        ...
        Class547.printChatMessage("x:" + (double)sPacketEntityVelocity.getMotionX() / 8000.0 + " y:" + (double)sPacketEntityVelocity.getMotionY() / 8000.0 + " z:" + (double)sPacketEntityVelocity.getMotionZ() / 8000.0);
        Class547.printChatMessage(String.valueOf(this.Field135));
    }

    private double Method112(double d, double d2, double d3) {
        return Math.sqrt(Class29.getDouble6(d) + Class29.getDouble6(d2) + Class29.getDouble6(d3));
    }
