...
extends Module {
    ...
    public Class619() {
        super("ColorTest", "", Category.CLIENT, "");
        this.addSetting(this.Field2681);
        this.addSetting(this.Field2682);
        this.addSetting(this.Field2683);
    }

    public void Method3315() {
        super.getEnable();
        Class547.printChatMessage("WARNING! SATURATION AND BRIGHTNESS MUST HAVE THE SAME VALUE IN BOTH COLORS!");
